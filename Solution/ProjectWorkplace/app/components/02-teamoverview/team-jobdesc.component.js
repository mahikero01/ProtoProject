...
var TeamJobDescComponent = (function () {
    function TeamJobDescComponent() {
        this.slides = [];
        this.breadcrumbs = ['Team Overview', 'Team Information', 'Job Description'];
...
TeamJobDescComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.TeamJobDescComponent = TeamJobDescComponent;
